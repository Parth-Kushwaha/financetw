  ...
  return (
      <div className='bg-gray-200  w-full shadow-xl flex flex-col py-4 my-4 rounded-lg hover:scale-105 duration-300'>
            ...
            <div className='text-center font-medium'>
                <p className='py-2 border-b border-black mx-8 mt-4'>{card.storage}</p>
                <p className='py-2 border-b border-black mx-8'>{card.user2}</p>
                <p className='py-2 border-b border-black mx-8'>{card.send}</p>
            </div>
